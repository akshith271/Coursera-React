...
class Contact extends Component {
    ...
    handleBlur = (field) => {
        //which ever input box has been modified, that input box value is set to true
    ...
    validate(firstname, lastname, telnum, email) {
        ...
        if (this.state.touched.firstname && firstname.length < 3) {
            ...
            errors.firstname =
                'First Name should not have more than 10 characters'
        }
        if (this.state.touched.lastname && lastname.length < 3) {
            errors.lastname = 'Last Name should have more than 3 characters'
        } else if (this.state.touched.lastname && lastname.length > 10) {
            errors.lastname =
                'Last Name should not have more than 10 characters'
        }
        const reg = /^\d + $/;
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input
                                        ...
                                        invalid={touched.telnum && errors.telnum}
